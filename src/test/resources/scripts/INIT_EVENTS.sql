INSERT INTO day_events (id, organizer_id, start_date, end_date, recurrence_frequency, recurrence_step,
                        monthly_recurrence_type, weekly_recurrence_days, recurrence_duration, recurrence_end_date,
                        number_of_occurrences)
VALUES ('4472d36c-2051-40e3-a2cf-00c6497807b5', 2, '2024-09-30', '2024-09-30', 'DAILY', 4, NULL, NULL, 'UNTIL_DATE',
        '2024-10-14', NULL),
       ('6b9b32f2-3c2a-4420-9d52-781c09f320ce', 3, '2024-09-30', '2024-09-30', 'NEVER', NULL, NULL, NULL, NULL, NULL,
        NULL);

INSERT INTO day_event_slots (id, event_id, title, location, start_date, end_date)
...
-- UTC times
INSERT INTO time_events (id, organizer_id, start_time, start_time_zone_id, end_time, end_time_zone_id,
                         recurrence_frequency, recurrence_step, monthly_recurrence_type, weekly_recurrence_days,
                         recurrence_duration, recurrence_end_date, number_of_occurrences)
VALUES ('0c9d6398-a6de-47f0-8328-04a2f3c0511c', 1, '2024-10-11T09:00:00', 'Europe/London', '2024-10-15T14:00:00',
        'Europe/London', 'WEEKLY', 2, NULL, 'FRIDAY', 'N_OCCURRENCES', NULL, 3), -- UTC times
       ('00026b7d-85ad-490a-8875-a85b3e5f37de', 2, '2024-10-28T13:00:00', 'Asia/Tokyo', '2024-10-28T15:30:00',
        'Asia/Tokyo', 'NEVER', NULL, NULL, NULL, NULL, NULL, NULL); -- UTC times

INSERT INTO time_event_slots (id, event_id, title, location, description, start_time, start_time_zone_id, end_time,
                              end_time_zone_id)
VALUES ('3075c6eb-8028-4f99-8c6c-27db1bb5cc43', '0c9d6398-a6de-47f0-8328-04a2f3c0511c', 'Event title', 'Location',
        'Description', '2024-10-15T09:00:00', 'Europe/London', '2024-10-15T14:00:00', 'Europe/London'), -- UTC times
       ('f8020ab5-1bc8-4b45-9d77-1a3859c264dd', '0c9d6398-a6de-47f0-8328-04a2f3c0511c', 'Event title', 'Location',
        'Description', '2024-10-29T09:00:00', 'Europe/London', '2024-10-29T14:00:00', 'Europe/London'), -- UTC times
       ('446d9d18-2a94-4bcf-b70d-b79941e9c31a', '0c9d6398-a6de-47f0-8328-04a2f3c0511c', 'Event title', 'Location',
        'Description', '2024-11-12T10:00:00', 'Europe/London', '2024-11-12T15:00:00',
        'Europe/London'), -- UTC times after DST
