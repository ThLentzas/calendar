...
CREATE TABLE IF NOT EXISTS user_contacts (
    ...
    CONSTRAINT pk_user_contacts PRIMARY KEY (user_id_1, user_id_2),
    CONSTRAINT fk_user_contacts_users_user_id_1 FOREIGN KEY (user_id_1) REFERENCES users(id) ON DELETE CASCADE,
    CONSTRAINT fk_user_contacts_users_user_id_2 FOREIGN KEY (user_id_2) REFERENCES users(id) ON DELETE CASCADE
);